    ...
    <div className="presentation">
      ...
      <div className="container-presentation">
        <section className="section-name">
          <h1>Gabriel Vidigal</h1>
          <h3>Desenvolvedor Full Stack</h3>
          <div className="container-icons">
            <a target="_blank" href="https://www.linkedin.com/in/gabriel-vidigal-5103a0218/"><BsLinkedin size={25} color="white"/></a>
            <a target="_blank" href="https://github.com/GabrielVidigal"><BsGithub size={25} color="white"/></a>
          </div>
        </section>
            ...
            <div className="division">
              ...
              <div className="container-data">
                ...
                <p>
                  ...
                  <span className="string">"Gabriel Vidigal"</span>
                ...
                <p className="object">
                  institute: <span className="string">"Escola Superior Dom Helder Câmara"</span>
                  <span className="comma">,</span>
                </p>
                <p className="object">
                  concluded: <span className="string">"In progress"</span>
                  <span className="comma">,</span>
                </p>
